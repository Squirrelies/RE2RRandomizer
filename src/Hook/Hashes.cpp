...
namespace RE2RR::Hook::Hashes
{
	...
	{
		std::unique_ptr<uint8_t[]> gameExeSHA256Hash = RE2RR::Common::File::GetFileHashSHA256(filePath);
		std::vector<uint8_t> hashVector = RE2RR::Common::File::HashSHA256ToVector(gameExeSHA256Hash.get());

		logger.LogMessage("[RE2R-R] Game hash: {:s}\n"sv, RE2RR::Common::File::VectorToHexString(hashVector).get()->c_str());

		bool success = false;
		if (hashVector == WW_DX11_20230421_1)
		{
			gameVersion = RE2RR::Types::Enums::RE2RGameVersion::RE2R_20230421_1;
			gameEdition = RE2RR::Types::Enums::RE2RGameEdition::WorldWide;
			gameDXVersion = RE2RR::Types::Enums::RE2RGameDXVersion::DirectX11;
			success = true;
		}
		else if (hashVector == WW_DX12_20230814_1)
		{
			gameVersion = RE2RR::Types::Enums::RE2RGameVersion::RE2R_20230814_1;
			gameEdition = RE2RR::Types::Enums::RE2RGameEdition::WorldWide;
			gameDXVersion = RE2RR::Types::Enums::RE2RGameDXVersion::DirectX12;
			success = true;
		}
		else if (hashVector == CEROZ_DX11_20230421_1)
		{
			gameVersion = RE2RR::Types::Enums::RE2RGameVersion::RE2R_20230421_1;
			gameEdition = RE2RR::Types::Enums::RE2RGameEdition::CeroZ;
			gameDXVersion = RE2RR::Types::Enums::RE2RGameDXVersion::DirectX11;
			success = true;
		}
		...
		if (success)
			logger.LogMessage("[RE2R-R] Game version: {:s} {:s} ({:s})\n"sv,
			                  RE2RR::Types::Enums::EnumRE2RGameEditionToString(gameEdition).get()->c_str(),
			                  RE2RR::Types::Enums::EnumRE2RGameDXVersionToString(gameDXVersion).get()->c_str(),
			                  RE2RR::Types::Enums::EnumRE2RGameVersionToString(gameVersion).get()->c_str());
		else
